...
| **base** (numpy 1.26.4 / pandas 2.2.2 / sklearn 1.5.1), Python 3.12 | green — 1,966 passed / 39 skipped (10 doc-block and 4 docstring-example skips are optional-dependency gates) |
